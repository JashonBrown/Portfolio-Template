...
// Format: <ProjectWebGLCard url='https://itch.io/embed-upload/project_id'/> where the url is the src url from the iframe on the "Embed Game" page on itch.io. 
...
export default function ProjectWebGLCard(props) {
    ...
    return (
        <div className="project-web-gl-card" style={{aspectRatio: aspectRatio}}>
                <iframe frameBorder="0" title="Game Embed Card" src={props.url + "?color=333333"} allowFullScreen="" width="100%" height="100%"/>
        </div>
    )
}
